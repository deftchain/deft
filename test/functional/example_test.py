...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the DeftTestFramework
    pass

class ExampleTest(DeftTestFramework):
    # Each functional test is a subclass of the DeftTestFramework class.
    ...
    def custom_method(self):
        ...
        DeftTestFramework class so other tests can use it."""
