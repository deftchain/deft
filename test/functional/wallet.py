...
class WalletTest(DeftTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 DEFT from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 DEFT with subtract fee from amount
        ...
        # Sendmany 10 DEFT with subtract fee from amount
