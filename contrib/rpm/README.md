...
The RPM spec file provided here is for Deft-Core 0.12.0 and builds on CentOS
...
[Deft git repository](https://github.com/bitcoin/bitcoin) but are not part of
...
in the bitcoin git repository. At present only an SVG version of the Deft
icon is used.
...
needed when 0.12.1 is released, a proper fix is already in the Deft git
master branch.
...
idea to build Deft against a static version of that library compiled
...
Deft-Core against OpenSSL or use a patched version of Boost in the build
system.
...
packaging Deft for Fedora at least since 2012.
