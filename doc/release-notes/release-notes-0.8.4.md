Deft-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/bitcoin/files/Deft/bitcoin-0.8.4/
...
code, causing the Deft-Qt or bitcoind process to crash.
...
their own version of Deft against Boost versions 1.50-1.52.
