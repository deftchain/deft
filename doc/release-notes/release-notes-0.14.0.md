Deft version 0.14.0 is now available from:
...
Deft has supported automatically pruning the blockchain since 0.11. Pruning
...
When Deft is out-of-sync on startup, a semi-transparent information
...
The Alert System was [disabled and deprecated](https://bitcoin.org/en/alert/2016-11-01-alert-retirement) in Deft 0.12.1 and removed in 0.13.0. 
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   about the memory usage of Deft. This was added in conjunction with
