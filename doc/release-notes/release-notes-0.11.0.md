Deft version 0.11.0 is now available from:
...
defaults to 0.00001. This will cause transactions with fewer DEFT/kB fee to be
...
Block pruning allows Deft to delete the raw block and undo data once 
...
block index and UTXO databases. The minimum was chosen so that Deft will 
...
- #5729 `9c4a5a5` Allow unit changes for read-only DeftAmountField
...
- #6116 `30dc3c1` [OSX] rename Deft-Qt.app to Deft-Core.app
