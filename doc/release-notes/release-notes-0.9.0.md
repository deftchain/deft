Deft version 0.9.0 is now available from:
...
earlier versions of Deft, then run the installer (on Windows) or just copy
over /Applications/Deft-Qt (on Mac) or bitcoind/bitcoin-qt (on Linux).

If you are upgrading from version 0.7.2 or earlier, the first time you run
0.9.0 your blockchain files will be re-indexed, which will take anywhere from 
30 minutes to several hours, depending on the speed of your machine.

On Windows, do not forget to uninstall all earlier versions of the Deft
...
To reduce confusion between Deft-the-network and Deft-the-software we
have renamed the reference client to Deft.
...
Using the standard "./autogen.sh; ./configure; make" to build Deft-Qt and
...
0.1mDEFT per kilobyte. During periods of heavy transaction volume, even this
...
- Drop the fee required to relay a transaction to 0.01mDEFT per kilobyte
