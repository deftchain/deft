Download URL: https://sourceforge.net/projects/bitcoin/files/Deft/bitcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 DEFT fee schedule (users still pay 0.01 DEFT per kb, until next version)
