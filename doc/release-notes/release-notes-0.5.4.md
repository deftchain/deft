Deft version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoin/files/Deft/bitcoin-0.5.4/
...
Fix Deft-Qt notifications under Growl 1.3.
Increase required age of Deft-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxDeft properly when installing Deft-Qt over it. (Windows)
