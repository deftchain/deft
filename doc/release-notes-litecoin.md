Deft version *0.15.1* is now available from:

  <https://download.deft.org/deft-0.15.1/>
...
A number of changes to the way Deft deals with peer connections and invalid blocks
