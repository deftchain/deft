...
The purpose of this library is to make the verification functionality that is critical to Deft's consensus available to other applications, e.g. to language bindings.
...
- [NDeft](https://github.com/NicolasDorier/NDeft/blob/master/NDeft/Script.cs#L814) (.NET Bindings)
