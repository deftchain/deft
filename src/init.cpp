...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/deft-project/deft>";
    const std::string URL_WEBSITE = "<https://deft.org>";
...
/** Sanity checks
 *  Ensure that Deft is running in a usable environment with all
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single Deft process is using the data directory.
