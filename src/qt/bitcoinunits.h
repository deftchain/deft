...
/** Deft unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class DeftUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit DeftUnits(QObject *parent);
...
typedef DeftUnits::Unit DeftUnit;
