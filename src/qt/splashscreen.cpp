...
//#endif
    ...
    QString titleText       = QString("deft");
    QString versionText     = QString("v0.15.1");
...
//#endif
    ...
    QRect rectIcon(QPoint(0,0), QSize(430,440));

    const QSize requiredSize(444,440);
