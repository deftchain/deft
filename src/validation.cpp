...
#if defined(NDEBUG)
# error "Deft cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Deft Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s DEFT additional fees, %d delta bytes\n",
...
static bool CheckBlockHeader(const CBlockHeader& block, CValidationState& state, const Consensus::Params& consensusParams, bool fCheckPOW = true)
{
    ...
    //to those watching in horror, this gets checked much more thoroughly elsewhere..
